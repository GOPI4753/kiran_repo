      ...
      success: function(json) {
        ...
        if (json['success']) {
          ...
          var html = '<div class="alert alert-success"><i class="fa fa-check-circle"></i> ' + json['success'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>';
           ...
           $("#bring-modalbox .modal-body").html( html );
          $("#bring-modalbox").modal('show');  
          setTimeout(function () {
...
//button banner header v3+v4
$(document).ready(function() {
  $('button.btn-banner').click(function() {
    $('#header-top').addClass("hidden-banner");
  });
  /*-------------Milestone Counter----------*/
